...
use actix_web::error;
use actix_web::{web,get, post, put, delete, HttpResponse, Result, Error};

#[get("/all")]
pub async fn get_all_users(user_service: web::Data<UserService<'_>>) -> Result<HttpResponse, Error> {
